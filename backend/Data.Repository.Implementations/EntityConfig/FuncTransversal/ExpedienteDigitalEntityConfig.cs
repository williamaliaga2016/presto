...
{
    internal class ExpedienteDigitalEntityConfig
    {
        public static void SetEntityBuilder(EntityTypeBuilder<expediente_digital_entity> entityTypeBuilder)
        {
            entityTypeBuilder.ToTable("expediente_digital");
            entityTypeBuilder.HasKey(q => q.id_archivo);
            entityTypeBuilder.Property(q => q.id_expediente).IsRequired();
            entityTypeBuilder.Property(q => q.id_documento).IsRequired();
            entityTypeBuilder.Property(q => q.id_usuario).IsRequired();
            entityTypeBuilder.Property(q => q.nombre_archivo).IsRequired();
            entityTypeBuilder.Property(q => q.nombre_archivo_original).IsRequired();
            entityTypeBuilder.Property(q => q.extension).IsRequired();
            entityTypeBuilder.Property(q => q.version_archivo).IsRequired();
