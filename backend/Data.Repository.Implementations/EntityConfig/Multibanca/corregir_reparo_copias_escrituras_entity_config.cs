...
{
    internal class corregir_reparo_copias_escrituras_entity_config
    {
        public static void SetEntityBuilder(EntityTypeBuilder<corregir_reparo_copias_escrituras_entity> entityTypeBuilder)
        {
            entityTypeBuilder.ToTable("corregir_reparo_copias_escrituras");

            entityTypeBuilder.HasKey(q => q.id_corregir_reparo_copias_escrituras);

            entityTypeBuilder.Property(q => q.id_corregir_reparo_copias_escrituras).IsRequired();
