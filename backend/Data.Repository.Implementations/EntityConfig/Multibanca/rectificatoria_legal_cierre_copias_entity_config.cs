...
{
    internal class rectificatoria_legal_cierre_copias_entity_config
    {
        public static void SetEntityBuilder(EntityTypeBuilder<rectificatoria_legal_cierre_copias_entity> entityTypeBuilder)
        {
            entityTypeBuilder.ToTable("rectificatoria_legal_cierre_copias");

            entityTypeBuilder.HasKey(q => q.id_rectificatoria_legal_cierre_copias);

            entityTypeBuilder.Property(q => q.id_rectificatoria_legal_cierre_copias).IsRequired();
