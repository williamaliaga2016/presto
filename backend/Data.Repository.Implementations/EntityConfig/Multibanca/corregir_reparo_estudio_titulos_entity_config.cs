...
{
    internal class corregir_reparo_estudio_titulos_entity_config
    {
        public static void SetEntityBuilder(
            EntityTypeBuilder<corregir_reparo_estudio_titulos_entity> entityTypeBuilder
        )
        {
            entityTypeBuilder.ToTable("corregir_reparo_estudio_titulos");

            entityTypeBuilder.HasKey(q => q.id_corregir_reparo_estudio_titulos);

            entityTypeBuilder.Property(q => q.id_corregir_reparo_estudio_titulos).IsRequired();
