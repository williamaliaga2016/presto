...
{
    internal class validacion_rectificatoria_legal_postventa_entity_config
    {
        public static void SetEntityBuilder(EntityTypeBuilder<validacion_rectificatoria_legal_postventa_entity> entityTypeBuilder)
        {
            entityTypeBuilder.ToTable("validacion_rectificatoria_legal_postventa");

            entityTypeBuilder.HasKey(q => q.id_validacion_rectificatoria_legal_postventa);
