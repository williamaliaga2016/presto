...
namespace Data.Repository.Implementations.EntityConfig.Multibanca.ValidacionRectificatoriaLegalPostventa
{
    internal class validacion_rectificatoria_legal_postventa_datos_personales_entity_config
    {
        public static void SetEntityBuilder(EntityTypeBuilder<validacion_rectificatoria_legal_postventa_datos_personales_entity> entityTypeBuilder)
        {
            entityTypeBuilder.ToTable("validacion_rectificatoria_legal_postventa_datos_personales");

            entityTypeBuilder.HasKey(q => q.id_validacion_rectificatoria_legal_postventa_datos_personales);

            entityTypeBuilder.Property(q => q.id_validacion_rectificatoria_legal_postventa_datos_personales)
                .HasColumnName("id_validacion_rectificatoria_legal_postventa_datos_personales")
                .IsRequired();

            entityTypeBuilder.Property(q => q.id_validacion_rectificatoria_legal_postventa)
