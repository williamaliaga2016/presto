...
{
    internal class rectificatoria_firma_post_venta_detalle_entity_config
    {
        public static void SetEntityBuilder(EntityTypeBuilder<rectificatoria_firma_post_venta_detalle_entity> entityTypeBuilder)
        {
            entityTypeBuilder.ToTable("rectificatoria_firma_post_venta_detalle");

            entityTypeBuilder.HasKey(q => q.id_rectificatoria_firma_post_venta_detalle);

            entityTypeBuilder.Property(q => q.id_rectificatoria_firma_post_venta_detalle).IsRequired();
            entityTypeBuilder.Property(q => q.id_rectificatoria_firma_post_venta).IsRequired();
