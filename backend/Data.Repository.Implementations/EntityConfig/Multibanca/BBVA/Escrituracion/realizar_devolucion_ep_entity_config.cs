...
internal class realizar_devolucion_ep_entity_config
{
    public static void SetEntityBuilder(EntityTypeBuilder<realizar_devolucion_ep_entity> entityTypeBuilder)
    {
        entityTypeBuilder.ToTable("realizar_devolucion_ep");
        ...
        entityTypeBuilder.Property(q => q.accion_a_seguir).HasColumnName("accion_a_seguir").HasMaxLength(100);
        ...
        entityTypeBuilder.HasIndex(q => q.id_expediente)
            .HasDatabaseName("idx_realizar_devolucion_ep_expediente")
            .IsUnique()
