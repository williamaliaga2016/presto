...
{
    internal class datos_operacion_propiedad_entity_config
    {
        public static void SetEntityBuilder(EntityTypeBuilder<datos_operacion_propiedad_entity> entityTypeBuilder)
        {
            entityTypeBuilder.ToTable("datos_operacion_propiedad");

            entityTypeBuilder.HasKey(q => q.id_datos_operacion_propiedad);

            entityTypeBuilder.Property(q => q.id_datos_operacion_propiedad)
