...
{
    internal class datos_operacion_vendedor_entity_config
    {
        public static void SetEntityBuilder(EntityTypeBuilder<datos_operacion_vendedor_entity> entityTypeBuilder)
        {
            entityTypeBuilder.ToTable("datos_operacion_vendedor");

            entityTypeBuilder.HasKey(q => q.id_datos_operacion_vendedor);

            entityTypeBuilder.Property(q => q.id_datos_operacion_vendedor)
