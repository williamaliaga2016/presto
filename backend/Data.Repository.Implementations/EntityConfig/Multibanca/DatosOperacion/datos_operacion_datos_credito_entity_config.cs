...
{
    internal class datos_operacion_datos_credito_entity_config
    {
        public static void SetEntityBuilder(EntityTypeBuilder<datos_operacion_datos_credito_entity> entityTypeBuilder)
        {
            entityTypeBuilder.ToTable("datos_operacion_datos_credito");

            entityTypeBuilder.HasKey(q => q.id_datos_operacion_datos_credito);

            entityTypeBuilder.Property(q => q.id_datos_operacion_datos_credito)
