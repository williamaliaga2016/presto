...
{
    internal class datos_operacion_comprador_entity_config
    {
        public static void SetEntityBuilder(EntityTypeBuilder<datos_operacion_comprador_entity> entityTypeBuilder)
        {
            entityTypeBuilder.ToTable("datos_operacion_comprador");

            entityTypeBuilder.HasKey(q => q.id_datos_operacion_comprador);

            entityTypeBuilder.Property(q => q.id_datos_operacion_comprador)
