...
{
    internal class verificar_correccion_escritura_entity_config
    {
        public static void SetEntityBuilder(EntityTypeBuilder<verificar_correccion_escritura_entity> entityTypeBuilder)
        {
            entityTypeBuilder.ToTable("verificar_correccion_escritura");

            entityTypeBuilder.HasKey(q => q.id_verificar_correccion_escritura);

            entityTypeBuilder.Property(q => q.id_verificar_correccion_escritura)
