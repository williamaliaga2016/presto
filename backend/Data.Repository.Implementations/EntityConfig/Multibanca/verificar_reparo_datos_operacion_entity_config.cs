...
{
    internal class verificar_reparo_datos_operacion_entity_config
    {
        public static void SetEntityBuilder(EntityTypeBuilder<verificar_reparo_datos_operacion_entity> entityTypeBuilder)
        {
            entityTypeBuilder.ToTable("verificar_reparo_datos_operacion");

            entityTypeBuilder.HasKey(q => q.id_verificar_reparo_datos_operacion);

            entityTypeBuilder.Property(q => q.id_verificar_reparo_datos_operacion).IsRequired();
