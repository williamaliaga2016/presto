...
{
    internal class rectificatoria_firma_post_venta_entity_config
    {
        public static void SetEntityBuilder(EntityTypeBuilder<rectificatoria_firma_post_venta_entity> entityTypeBuilder)
        {
            entityTypeBuilder.ToTable("rectificatoria_firma_post_venta");

            entityTypeBuilder.HasKey(q => q.id_rectificatoria_firma_post_venta);
