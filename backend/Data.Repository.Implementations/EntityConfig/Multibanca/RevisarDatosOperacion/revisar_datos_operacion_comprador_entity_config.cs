...
{
    internal class revisar_datos_operacion_comprador_entity_config
    {
        public static void SetEntityBuilder(EntityTypeBuilder<revisar_datos_operacion_comprador_entity> entityTypeBuilder)
        {
            entityTypeBuilder.ToTable("revisar_datos_operacion_comprador");

            entityTypeBuilder.HasKey(q => q.id_revisar_datos_operacion_comprador);

            entityTypeBuilder.Property(q => q.id_revisar_datos_operacion_comprador)
