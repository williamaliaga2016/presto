...
{
    internal class corregir_reparo_entregar_carpeta_entity_config
    {
        public static void SetEntityBuilder(
            EntityTypeBuilder<corregir_reparo_entregar_carpeta_entity> entityTypeBuilder
        )
        {
            entityTypeBuilder.ToTable("corregir_reparo_entregar_carpeta");

            entityTypeBuilder.HasKey(q => q.id_corregir_reparo_entregar_carpeta);

            entityTypeBuilder.Property(q => q.id_corregir_reparo_entregar_carpeta).IsRequired();
