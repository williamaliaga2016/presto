...
{
    internal class corregir_reparo_cierre_copias_notaria_entity_config
    {
        public static void SetEntityBuilder(
            EntityTypeBuilder<corregir_reparo_cierre_copias_notaria_entity> entityTypeBuilder
        )
        {
            entityTypeBuilder.ToTable("corregir_reparo_cierre_copias_notaria");

            entityTypeBuilder.HasKey(q => q.id_corregir_reparo_cierre_copias_notaria);

            entityTypeBuilder.Property(q => q.id_corregir_reparo_cierre_copias_notaria).IsRequired();
