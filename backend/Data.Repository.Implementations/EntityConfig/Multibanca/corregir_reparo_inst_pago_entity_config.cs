...
{
    internal class corregir_reparo_inst_pago_entity_config
    {
        public static void SetEntityBuilder(
            EntityTypeBuilder<corregir_reparo_inst_pago_entity> entityTypeBuilder
        )
        {
            entityTypeBuilder.ToTable("corregir_reparo_inst_pago");

            entityTypeBuilder.HasKey(q => q.id_corregir_reparo_inst_pago);

            entityTypeBuilder.Property(q => q.id_corregir_reparo_inst_pago).IsRequired();
            ...
            entityTypeBuilder.Property(q => q.enviar_a_reparo).IsRequired();
