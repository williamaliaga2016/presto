...
{
    internal class corregir_reparo_liquidacion_entity_config
    {
        public static void SetEntityBuilder(EntityTypeBuilder<corregir_reparo_liquidacion_entity> entityTypeBuilder)
        {
            entityTypeBuilder.ToTable("corregir_reparo_liquidacion");

            entityTypeBuilder.HasKey(q => q.id_corregir_reparo_liquidacion);

            entityTypeBuilder.Property(q => q.id_corregir_reparo_liquidacion).IsRequired();
