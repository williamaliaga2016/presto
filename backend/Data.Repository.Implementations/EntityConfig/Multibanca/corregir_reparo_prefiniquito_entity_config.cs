...
{
    internal class corregir_reparo_prefiniquito_entity_config
    {
        public static void SetEntityBuilder(
            EntityTypeBuilder<corregir_reparo_prefiniquito_entity> entityTypeBuilder
        )
        {
            entityTypeBuilder.ToTable("corregir_reparo_prefiniquito");

            entityTypeBuilder.HasKey(q => q.id_corregir_reparo_prefiniquito);

            entityTypeBuilder.Property(q => q.id_corregir_reparo_prefiniquito).IsRequired();
