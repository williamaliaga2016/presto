...
{
    internal class corregir_carta_resguardo_entity_config
    {
        public static void SetEntityBuilder(
            EntityTypeBuilder<corregir_carta_resguardo_entity> entityTypeBuilder
        )
        {
            entityTypeBuilder.ToTable("corregir_carta_resguardo");

            entityTypeBuilder.HasKey(q => q.id_corregir_carta_resguardo);

            entityTypeBuilder.Property(q => q.id_corregir_carta_resguardo).IsRequired();
