...
{
    internal class reparo_estudio_titulos_detalle_entity_config
    {
        public static void SetEntityBuilder(EntityTypeBuilder<reparo_estudio_titulos_detalle_entity> entityTypeBuilder)
        {
            entityTypeBuilder.ToTable("reparo_estudio_titulos_detalle");

            entityTypeBuilder.HasKey(q => q.id_reparo_estudio_titulos);

            entityTypeBuilder.Property(q => q.id_reparo_estudio_titulos).IsRequired();
