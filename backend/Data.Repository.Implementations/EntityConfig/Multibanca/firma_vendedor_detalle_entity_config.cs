...
{
    internal class firma_vendedor_detalle_entity_config
    {
        public static void SetEntityBuilder(EntityTypeBuilder<firma_vendedor_detalle_entity> entityTypeBuilder)
        {
            entityTypeBuilder.ToTable("firma_vendedor_detalle");

            entityTypeBuilder.HasKey(q => q.id_firma_vendedor_detalle);

            entityTypeBuilder.Property(q => q.id_firma_vendedor).IsRequired();
