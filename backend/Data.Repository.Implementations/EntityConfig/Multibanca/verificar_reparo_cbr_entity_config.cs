...
{
    internal class verificar_reparo_cbr_entity_config
    {
        public static void SetEntityBuilder(EntityTypeBuilder<verificar_reparo_cbr_entity> entityTypeBuilder)
        {
            entityTypeBuilder.ToTable("verificar_reparo_cbr");

            entityTypeBuilder.HasKey(q => q.id_verificar_reparo_cbr);

            entityTypeBuilder.Property(q => q.id_verificar_reparo_cbr).IsRequired();
            ...
            entityTypeBuilder.Property(q => q.enviar_reparo_a).HasMaxLength(1000);
            entityTypeBuilder.Property(q => q.estatus_reparo).HasColumnName("estatus_reparo");
