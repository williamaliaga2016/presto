...
{
    internal class corregir_reparo_fabrica_entity_config
    {
        public static void SetEntityBuilder(EntityTypeBuilder<corregir_reparo_fabrica_entity> entityTypeBuilder)
        {
            entityTypeBuilder.ToTable("corregir_reparo_fabrica");

            entityTypeBuilder.HasKey(q => q.id_corregir_reparo_fabrica);

            entityTypeBuilder.Property(q => q.id_corregir_reparo_fabrica).IsRequired();
