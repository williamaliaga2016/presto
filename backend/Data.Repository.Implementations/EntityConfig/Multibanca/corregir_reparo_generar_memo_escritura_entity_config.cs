...
{
    internal class corregir_reparo_generar_memo_escritura_entity_config
    {
        public static void SetEntityBuilder(
            EntityTypeBuilder<corregir_reparo_generar_memo_escritura_entity> entityTypeBuilder
        )
        {
            entityTypeBuilder.ToTable("corregir_reparo_generar_memo_escritura");

            entityTypeBuilder.HasKey(q => q.id_corregir_reparo_generar_memo_escritura);

            entityTypeBuilder.Property(q => q.id_corregir_reparo_generar_memo_escritura).IsRequired();
