...
{
    internal class corregir_reparo_cdr_entity_config
    {
        public static void SetEntityBuilder(EntityTypeBuilder<corregir_reparo_cdr_entity> entityTypeBuilder)
        {
            entityTypeBuilder.ToTable("corregir_reparo_cdr");

            entityTypeBuilder.HasKey(q => q.id_corregir_reparo_cdr);

            entityTypeBuilder.Property(q => q.id_corregir_reparo_cdr).IsRequired();
