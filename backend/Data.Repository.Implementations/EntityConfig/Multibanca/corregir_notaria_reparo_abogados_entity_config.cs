...
{
    internal class corregir_notaria_reparo_abogados_entity_config
    {
        public static void SetEntityBuilder(
            EntityTypeBuilder<corregir_notaria_reparo_abogados_entity> entityTypeBuilder
        )
        {
            entityTypeBuilder.ToTable("corregir_notaria_reparo_abogados");

            entityTypeBuilder.HasKey(q => q.id_corregir_notaria_reparo_abogados);

            entityTypeBuilder.Property(q => q.id_corregir_notaria_reparo_abogados).IsRequired();
