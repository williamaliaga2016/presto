...
{
    internal class corregir_reparo_tasacion_entity_config
    {
        public static void SetEntityBuilder(EntityTypeBuilder<corregir_reparo_tasacion_entity> entityTypeBuilder)
        {
            entityTypeBuilder.ToTable("corregir_reparo_tasacion");

            entityTypeBuilder.HasKey(q => q.id_corregir_reparo_tasacion);

            entityTypeBuilder.Property(q => q.id_corregir_reparo_tasacion).IsRequired();
