...
{
    internal class revisar_liquidacion_entity_config
    {
        public static void SetEntityBuilder(EntityTypeBuilder<revisar_liquidacion_entity> entityTypeBuilder)
        {
            entityTypeBuilder.ToTable("revisar_liquidacion");

            entityTypeBuilder.HasKey(q => q.id_revisar_liquidacion);

            entityTypeBuilder.Property(q => q.id_revisar_liquidacion).IsRequired();
