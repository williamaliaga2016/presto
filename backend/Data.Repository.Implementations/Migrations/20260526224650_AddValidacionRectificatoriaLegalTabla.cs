...
{
    /// <inheritdoc />
    public partial class AddValidacionRectificatoriaLegalTabla : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "validacion_rectificatoria_legal",
                columns: table => new
                {
                    id_validacion_rectificatoria_legal = table.Column<int>(type: "integer", nullable: false)
                    ...
                    encargado_firma = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_validacion_rectificatoria_legal", x => x.id_validacion_rectificatoria_legal);
                });

            migrationBuilder.CreateTable(
                name: "validacion_rectificatoria_legal_datos_personales",
                columns: table => new
                {
                    id_validacion_rectificatoria_legal_datos_personales = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    id_validacion_rectificatoria_legal = table.Column<int>(type: "integer", nullable: false),
                    id_expediente = table.Column<long>(type: "bigint", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_validacion_rectificatoria_legal_datos_personales", x => x.id_validacion_rectificatoria_legal_datos_personales);
                });

            migrationBuilder.CreateIndex(
                name: "ix_validacion_rectificatoria_legal_expediente",
                table: "validacion_rectificatoria_legal",
                column: "id_expediente");

            migrationBuilder.CreateIndex(
                name: "ix_validacion_rectificatoria_legal_datos_personales_expediente",
                table: "validacion_rectificatoria_legal_datos_personales",
                column: "id_expediente");
        }
