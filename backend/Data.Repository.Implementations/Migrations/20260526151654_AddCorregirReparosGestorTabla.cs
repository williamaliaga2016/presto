...
{
    /// <inheritdoc />
    public partial class AddCorregirReparosGestorTabla : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "corregir_reparos_gestor",
                columns: table => new
                {
                    id_corregir_reparos_gestor = table.Column<int>(type: "integer", nullable: false)
                    ...
                    estatus_general = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_corregir_reparos_gestor", x => x.id_corregir_reparos_gestor);
                });

            migrationBuilder.CreateIndex(
                name: "ix_corregir_reparos_gestor_expediente",
                table: "corregir_reparos_gestor",
