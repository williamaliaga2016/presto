...
namespace Multibanca.Backend.Api.Controllers.Multibanca
{
    ...
    [ApiController]
    public class CorregirNotariaReparoAbogadosController : ControllerBase
    {
        private readonly ICorregirNotariaReparoAbogadosApplication CorregirNotariaReparoAbogadosApplicationProvider;
        private readonly IBitacoraApplication BitacoraApplicacionProvider;

        private readonly string ActividadID = Constants.Actividades.CorregirNotariaReparoAbogados;

        public CorregirNotariaReparoAbogadosController(
            ICorregirNotariaReparoAbogadosApplication _corregirNotariaReparoAbogadosApplication,
            IBitacoraApplication _bitacoraApplication,
            IWorkflowApplication _workflowApplication)
        {
            CorregirNotariaReparoAbogadosApplicationProvider = _corregirNotariaReparoAbogadosApplication;
        ...
        public async Task<IActionResult> GetByExpediente(long idExpediente)
        {
            ...
            {
                var result =
                    await CorregirNotariaReparoAbogadosApplicationProvider.GetByExpediente(
                        idExpediente
                    );
                ...
                return Ok(new
                {
                    status = true,
                    detail = result,
                    message = "Corregir Notaría Reparo Abogados obtenido correctamente."
                });
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> Save(
            [FromBody] corregir_notaria_reparo_abogados model
        )
        {
            ...
            try
            {
                ...
                corregir_notaria_reparo_abogados modelSaved;

                if (model.id_corregir_notaria_reparo_abogados == 0)
                {
                    model.row_status = true;
                    model.is_active = true;

                    modelSaved = CorregirNotariaReparoAbogadosApplicationProvider.Create(
                        model,
                        GetUserId()
                    );
                }
                ...
                {
                    modelSaved = CorregirNotariaReparoAbogadosApplicationProvider.Update(
                        model,
                        GetUserId()
                    );
                }
                ...
                corregir_notaria_reparo_abogados? result =
                    await CorregirNotariaReparoAbogadosApplicationProvider.GetByExpediente(
                        modelSaved.id_expediente
                    );
                ...
                response = Ok(new
                {
                    status = true,
                    detail = result,
                    message = "Corregir Notaría Reparo Abogados guardado correctamente."
                });
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> Avanzar(long id_expediente)
        {
            ...
            try
            {
                ...
                List<AssignActivityDTO> listAssignActividadesDTO =
                    await CorregirNotariaReparoAbogadosApplicationProvider.Avanzar(
                        id_expediente,
                        id_usuario,
                        ActividadID
                    );
