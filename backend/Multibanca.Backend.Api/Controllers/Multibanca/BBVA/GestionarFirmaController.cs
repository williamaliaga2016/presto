...
namespace Multibanca.Backend.Api.Controllers.Multibanca.BBVA
{
    [Authorize]
    [ApiController]
    [Route("api/gestionar-firma")]
    public class GestionarFirmaController(IGestionarFirmaApplication application) : ControllerBase
    {
        ...
        [HttpPost("guardar")]
        public async Task<IActionResult> Guardar([FromBody] gestionar_firma_bbva request)
        {
            try
            {
