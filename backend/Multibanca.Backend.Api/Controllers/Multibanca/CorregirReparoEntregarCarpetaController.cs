...
namespace Multibanca.Backend.Api.Controllers.Multibanca
{
    ...
    [ApiController]
    public class CorregirReparoEntregarCarpetaController : ControllerBase
    {
        private readonly ICorregirReparoEntregarCarpetaApplication CorregirReparoEntregarCarpetaApplicationProvider;
        private readonly IBitacoraApplication BitacoraApplicacionProvider;

        private readonly string ActividadID = Constants.Actividades.CorregirReparoEntregarCarpeta;

        public CorregirReparoEntregarCarpetaController(
            ICorregirReparoEntregarCarpetaApplication _corregirReparoEntregarCarpetaApplication,
            IBitacoraApplication _bitacoraApplication
        )
        {
            CorregirReparoEntregarCarpetaApplicationProvider = _corregirReparoEntregarCarpetaApplication;
        ...
        public async Task<IActionResult> GetByExpediente(long id_expediente)
        {
            ...
            {
                var result =
                    await CorregirReparoEntregarCarpetaApplicationProvider.GetByExpediente(
                        id_expediente
                    );
                ...
                return Ok(new
                {
                    status = true,
                    detail = result,
                    message = "Corregir Reparo Entregar Carpeta obtenido correctamente."
                });
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> Save(
            [FromBody] corregir_reparo_entregar_carpeta model
        )
        {
            ...
            try
            {
                ...
                corregir_reparo_entregar_carpeta modelSaved;

                if (model.id_corregir_reparo_entregar_carpeta == 0)
                {
                    model.row_status = true;
                    model.is_active = true;

                    modelSaved = CorregirReparoEntregarCarpetaApplicationProvider.Create(
                        model,
                        GetUserId()
                    );
                }
                ...
                {
                    modelSaved = CorregirReparoEntregarCarpetaApplicationProvider.Update(
                        model,
                        GetUserId()
                    );
                }
                ...
                corregir_reparo_entregar_carpeta? result =
                    await CorregirReparoEntregarCarpetaApplicationProvider.GetByExpediente(
                        modelSaved.id_expediente
                    );
                ...
                response = Ok(new
                {
                    status = true,
                    detail = result,
                    message = "Corregir Reparo Entregar Carpeta guardado correctamente."
                });
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> Avanzar(long id_expediente)
        {
            ...
            try
            {
                ...
                List<AssignActivityDTO> listAssignActividadesDTO =
                    await CorregirReparoEntregarCarpetaApplicationProvider.Avanzar(
                        id_expediente,
                        id_usuario,
                        ActividadID
                    );
