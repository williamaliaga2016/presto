...
namespace Multibanca.Backend.Api.Controllers.Multibanca
{
    ...
    [ApiController]
    public class CorregirReparoEstudioTitulosController : ControllerBase
    {
        private readonly ICorregirReparoEstudioTitulosApplication CorregirReparoEstudioTitulosApplicationProvider;
        private readonly IBitacoraApplication BitacoraApplicacionProvider;

        private readonly string ActividadID = Constants.Actividades.CorregirReparoEstudioTitulos;

        public CorregirReparoEstudioTitulosController(
            ICorregirReparoEstudioTitulosApplication _corregirReparoEstudioTitulosApplication,
            IBitacoraApplication _bitacoraApplication
        )
        {
            CorregirReparoEstudioTitulosApplicationProvider = _corregirReparoEstudioTitulosApplication;
        ...
        public async Task<IActionResult> GetByExpediente(long id_expediente)
        {
            ...
            {
                var result =
                    await CorregirReparoEstudioTitulosApplicationProvider.GetByExpediente(
                        id_expediente
                    );
                ...
                return Ok(new
                {
                    status = true,
                    detail = result,
                    message = "Corregir Reparo Estudio de Títulos obtenido correctamente."
                });
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> Save(
            [FromBody] corregir_reparo_estudio_titulos model
        )
        {
            ...
            try
            {
                ...
                corregir_reparo_estudio_titulos modelSaved;

                if (model.id_corregir_reparo_estudio_titulos == 0)
                {
                    model.row_status = true;
                    model.is_active = true;

                    modelSaved = CorregirReparoEstudioTitulosApplicationProvider.Create(
                        model,
                        GetUserId()
                    );
                }
                ...
                {
                    modelSaved = CorregirReparoEstudioTitulosApplicationProvider.Update(
                        model,
                        GetUserId()
                    );
                }
                ...
                corregir_reparo_estudio_titulos? result =
                    await CorregirReparoEstudioTitulosApplicationProvider.GetByExpediente(
                        modelSaved.id_expediente
                    );
                ...
                response = Ok(new
                {
                    status = true,
                    detail = result,
                    message = "Corregir Reparo Estudio de Títulos guardado correctamente."
                });
            }
            catch (Exception ex)
            {
        ...
        public async Task<IActionResult> Avanzar(long id_expediente)
        {
            ...
            try
            {
                ...
                List<AssignActivityDTO> listAssignActividadesDTO =
                    await CorregirReparoEstudioTitulosApplicationProvider.Avanzar(
                        id_expediente,
                        id_usuario,
                        ActividadID
                    );
