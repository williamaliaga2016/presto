...
namespace Multibanca.Backend.Api.Controllers.Multibanca
{
    ...
    [ApiController]
    public class CorregirReparoGenerarMemoEscrituraController : ControllerBase
    {
        private readonly ICorregirReparoGenerarMemoEscrituraApplication ApplicationProvider;
        private readonly IBitacoraApplication BitacoraApplicationProvider;

        private readonly string ActividadID = Constants.Actividades.CorregirReparoGenerarMemoEscritura;

        public CorregirReparoGenerarMemoEscrituraController(
            ICorregirReparoGenerarMemoEscrituraApplication application,
        ...
        public async Task<IActionResult> Save(
            [FromBody] corregir_reparo_generar_memo_escritura model
        )
        {
            ...
            try
            {
                ...
                corregir_reparo_generar_memo_escritura modelSaved;

                if (model.id_corregir_reparo_generar_memo_escritura == 0)
                {
                ...
                corregir_reparo_generar_memo_escritura? result =
