...
{
    public class carga_operacion_banco_antecedente_credito : base_auditoria
    {
        ...
        // ============================================================
        public string? id_tipo_sub_producto { get; set; }           // código subproducto BBVA
        public decimal? monto_otorgado { get; set; }                // COP — reemplaza monto_solicitado
        public DateTime? fecha_aprobacion { get; set; }             // fecha aprobación del crédito
        public string? condiciones_organismo_decisor { get; set; }  // texto condiciones
        ...
        public bool? gente_bbva { get; set; }                       // flag empleado BBVA
    }
}
