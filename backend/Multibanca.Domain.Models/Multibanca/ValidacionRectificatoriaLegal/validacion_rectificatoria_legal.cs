...
namespace Multibanca.Domain.Models.Multibanca.ValidacionRectificatoriaLegal
{
    public class validacion_rectificatoria_legal : base_auditoria
    {
        public int id_validacion_rectificatoria_legal { get; set; }
        ...
        public List<validacion_rectificatoria_legal_datos_personales>? validacion_rectificatoria_legal_datos_personales { get; set; }
    }
}
