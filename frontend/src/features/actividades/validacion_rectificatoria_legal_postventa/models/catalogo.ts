...
export interface ControlesValidacionRectificatoriaLegalPostventa {
...
export const EMPTY_CONTROLES_VALIDACION_RECTIFICATORIA_LEGAL_POSTVENTA: ControlesValidacionRectificatoriaLegalPostventa = {
  rol_comparecencia: [],
    genero: [],
    estado_civil: [],
    relacion_titular: [],
