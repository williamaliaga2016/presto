      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-x-4 gap-y-2">
          ...
          <div className="flex flex-col gap-0.5">
            ...
            <span className="text-sm font-medium text-gray-800">{datosHeredados.tipo_credito_desc ?? '-'}</span>
          </div>
        </div>
      </div>
      <div>
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-x-4 gap-y-2">
          <div className="flex flex-col gap-0.5">
            ...
            <span className="text-sm font-medium text-gray-800">{datosHeredados.numero_boleta ?? '-'}</span>
          </div>
          <div className="flex flex-col gap-0.5">
            <span className="text-xs text-gray-500">Fecha Ingreso</span>
            <span className="text-sm font-medium text-gray-800">{formatDate(datosHeredados.fecha_boleta)}</span>
          </div>
          <div className="flex flex-col gap-0.5">
            <span className="text-xs text-gray-500">Tipo Boleta</span>
            <span className="text-sm font-medium text-gray-800">{datosHeredados.tipo_boleta_desc ?? '-'}</span>
          </div>
          <div className="flex flex-col gap-0.5">
            <span className="text-xs text-gray-500">Oficina Registro</span>
            <span className="text-sm font-medium text-gray-800">{datosHeredados.oficina_registro_desc ?? '-'}</span>
          </div>
          <div className="flex flex-col gap-0.5">
            <span className="text-xs text-gray-500">Matrícula</span>
            <span className="text-sm font-medium text-gray-800">{datosHeredados.numero_matricula ?? '-'}</span>
          </div>
        </div>
      </div>
    </div>
