...
import type { DatosOperacionPropiedad } from '../models/datos_operacion';
import {
...
type Props = {
  value: DatosOperacionPropiedad | null | undefined;
  disabled: boolean;
  controles?: ControlesPropiedad;
  loadingControles?: boolean;
  onChange: <K extends keyof DatosOperacionPropiedad>(
    field: K,
