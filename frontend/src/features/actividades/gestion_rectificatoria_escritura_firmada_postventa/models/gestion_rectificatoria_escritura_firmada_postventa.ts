export interface GestionRectificatoriaEscrituraFirmadaPostventa {
  id_gestion_rectificatoria_escritura_firmada_postventa?: number | null;
  id_rectificatoria_analisis_derivacion_reparo_postventa?: number | null;
