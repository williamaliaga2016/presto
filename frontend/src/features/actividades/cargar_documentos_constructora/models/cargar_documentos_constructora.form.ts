import type { CargarDocumentosConstructora } from './cargar_documentos_constructora';
...
export function validateAvanzarFields(
  form: Pick<
    CargarDocumentosConstructora,
    'avanzar_validar_documentos' | 'observaciones'
  >,
): Set<string> {
...
export const normalizeCargarDocumentosConstructora = (
  ...
  avanzar_validar_documentos: Boolean(
    source?.avanzar_validar_documentos ?? false,
  ),
