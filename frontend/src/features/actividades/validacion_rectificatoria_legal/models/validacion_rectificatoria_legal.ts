...
export interface ValidacionRectificatoriaLegal {
  ...
  validacion_rectificatoria_legal_datos_personales?: ValidacionRectificatoriaLegalDatosPersonales[] | null;
  is_active: boolean;
  row_status: boolean;
  created_by: number;
  created_date: string;
...
export interface ValidacionRectificatoriaLegalDatosPersonales {
